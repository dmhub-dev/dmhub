...
export default function BlogList({
  ...
  return (
    <div className="container max-w-4xl w-full py-6">
...
const BlogPostCard = ({
  ...
  return (
    <Link
      className="group flex md:flex-row flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg focus:outline-none focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl"
      href={`/blog/${slug}`}
    >
      <div className="aspect-w-16 aspect-h-11">
        <img
          className="w-full md:w-[280px] h-full object-cover rounded-xl md:rounded-r-none"
          src={img}
          alt={title}
        />
      </div>
      <div className="p-5 w-full md:w-[calc(100%-280px)]">
        <div className="block">
          <h3
          ...
          />
          <div
            className={`mt-5 flex gap-4 items-center ${robotoCondensed.className}`}
          >
            {category && (
