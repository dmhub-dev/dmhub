    ...
    <div className="max-w-2xl ">
      ...
      <section>
        ...
        <p className="text-gray-700 mt-2">
          Noem hieronder redenen waarom consumenten voor u als uitvaartverzorger moeten kiezen, wat zijn uw voordelen en sterke punten. U kunt elke keer een extra voordeel toevoegen.
        </p>
