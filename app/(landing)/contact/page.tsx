...
const Contact = () => {
  return (
    <>
      ...
      <section className="container max-w-1200px w-full">
        <div className="w-full grid md:grid-cols-[1fr_280px] gap-6 py-6">
          <div className="w-full -mt-28 bg-white md:p-16 shadow-xl border">
