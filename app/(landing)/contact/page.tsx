  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start mt-12 mb-[5rem]">
        <div className="border border-gray-300 p-6 min-h-[100px] lg:w-[70%] -ml-30 mx-60 -mt-40 shadow-[0_0_5px_1px_rgb(209,209,209)] bg-white">
        ...
        <div className="lg:w-[25%] mt-12 lg:mt-0 lg:-ml-40">
          <SideBar />
        </div>
      </div>
    </>
